...
/***/ function(module, exports, __webpack_require__) {
	...
	var Renderer = function () {
	  ...
	  _createClass(Renderer, [{
	    ...
	    key: 'toggleLevelName',
	    value: function toggleLevelName(n) {
	    ...
	    key: 'displayLoadScreen',
	    value: function displayLoadScreen() {
	    ...
	    key: 'displayEndScreen',
	    value: function displayEndScreen() {
	      this.blackBackground();
	      this.c.fillStyle = 'white';
	      this.c.font = "bold 60px 'Inconsolata'";
	    ...
	    key: 'getVisibleSquares',
	    value: function getVisibleSquares(origin, currentLevel) {
	    ...
	    value: function renderForeground(origin, currentLevel, cornerSquares) {
	    ...
	    value: function renderBackground(origin, currentLevel, cornerSquares) {
	      var rowTopY = cornerSquares[0] * BLOCK_LENGTH;
	      for (var row = cornerSquares[0]; row <= cornerSquares[2]; row++) {
	        var colLeftX = cornerSquares[1] * BLOCK_LENGTH;
	        for (var col = cornerSquares[1]; col <= cornerSquares[3]; col++) {
	    ...
	    key: 'renderElevators',
	    value: function renderElevators(origin, currentLevel, cornerSquares) {
	      var colLeftX = cornerSquares[1] * BLOCK_LENGTH;
	    ...
	    key: 'drawElevator',
	    value: function drawElevator(xBlock, adjustedPlatformTop, relBaseBottomY, exit) {
	      var COLUMN_WIDTH = 25;
	    ...
	    key: 'renderBackgroundObjects',
	    value: function renderBackgroundObjects(objects, origin, currentLevel, cornerSquares) {
	    ...
	    key: 'renderRobot',
	    value: function renderRobot(robot) {
	    ...
	    key: 'drawDoor',
	    value: function drawDoor(door, pos) {
	      var TOOTH_HEIGHT = 8;
	      if (door.status !== "open") {
	        var x = pos[0];
	        var y = pos[1];
	        var width = Math.floor(BLOCK_LENGTH / 3);
	        var topLeftCorner = void 0;
	        var topRightCorner = void 0;
	        var bottomRightCorner = void 0;
	        var bottomLeftCorner = void 0;
	        if (door.side === "right") {
	    ...
	    key: 'drawPlatform',
	    value: function drawPlatform(pos, topColor, bottomColor) {
	      var x = pos[0];
	      var y = pos[1];
	    ...
	    key: 'drawWireJunction',
	    value: function drawWireJunction(pos, wireJunction) {
	    ...
	    key: 'drawWire',
	    value: function drawWire(pos, wire) {
	    ...
	    key: 'drawCubby',
	    value: function drawCubby(pos, cubby) {
	      var x = pos[0] + 15;
	      var y = pos[1] + 15;
	      this.drawRectangle({
	        x: x,
	    ...
	    key: 'drawBrick',
	    value: function drawBrick(pos, color, leftEdges) {
	      var x = pos[0];
	      var y = pos[1];
	    ...
	    key: 'drawButtonBlock',
	    value: function drawButtonBlock(buttonBlock, pos) {
	      this.drawPowerBlock(pos, buttonBlock.hasPower);
	      var buttonPanelX = void 0;
	    ...
	    key: 'drawSpringPowerUp',
	    value: function drawSpringPowerUp(pos) {
	      this.drawRectangle({
	        x: pos[0] + 25,
	        y: pos[1] + 15,
	        fill: 'yellow',
	    ...
	    key: 'drawForceFieldBlock',
	    value: function drawForceFieldBlock(pos, FFBlock) {
	    ...
	    key: 'drawForceEmitter',
	    value: function drawForceEmitter(pos, fill) {
	      this.c.beginPath();
	    ...
	    key: 'drawForceField',
	    value: function drawForceField(pos) {
	    ...
	    key: 'drawForceLine',
	    value: function drawForceLine(pos) {
	    ...
	    key: 'drawPowerBlock',
	    value: function drawPowerBlock(pos, power) {
	    ...
	    key: 'drawOuterSquare',
	    value: function drawOuterSquare(pos, stroke, fill) {
	      this.drawRectangle({
	        x: pos[0],
	        y: pos[1],
	    ...
	    key: 'blackBackground',
	    value: function blackBackground() {
	      this.drawRectangle({
	        x: 0,
	        y: 0,
	        width: 600,
	    ...
	    key: 'drawFullCircle',
	    value: function drawFullCircle(options) {
	      this.c.beginPath();
	    ...
	    key: 'drawLine',
	    value: function drawLine(start, finish) {
	      this.c.beginPath();
	    ...
	    key: 'drawRectangle',
	    value: function drawRectangle(object) {
	      var x = object.x;
	      var y = object.y;
	    ...
	    key: 'drawFrame',
	    value: function drawFrame(object) {
	      var x = object.x;
	      var y = object.y;
	      var width = object.width;
	      var height = object.height;
	    ...
	    key: 'incrementGradientIndex',
	    value: function incrementGradientIndex() {
	    ...
	    key: 'fillGradientArray',
	    value: function fillGradientArray(rgbColor, arrayLength) {
	    ...
	    key: 'shadeRGBColor',
	    value: function shadeRGBColor(color, percent) {
	      var f = color.split(",");
	      ...
	      if (this.status === "rising" || this.status === "finished") {
	        ...
	        if (39 in this.keysDown) {
	          ...
	          if (this.passThrough(topObj, aboveTopObj, "left") === false || this.passThrough(bottomObj, topObj, "left") === false) {
	            ...
	            var _buttonStuff = this.getRightButtonEdge(ghostArrays);
	            if (_buttonStuff !== -1) {
	              edge = _buttonStuff[0];
